...
function CollapsibleTrigger(props: CollapsibleTriggerProps) {
  ...
  return (
    <KobalteCollapsible.Trigger
      classList={{
        "w-full group/collapsible cursor-pointer transition-colors duration-[var(--duration-normal)]": true,
...
function CollapsibleContent(props: ParentProps<CollapsibleContentProps>) {
  ...
  return (
    <KobalteCollapsible.Content
      classList={{
        "h-0 overflow-hidden transition-all duration-[var(--duration-slow)] ease-out": true,
...
function CollapsibleArrow(props: Partial<IconProps>) {
  ...
  return (
    <Icon
      ...
      classList={{
        "flex-none text-text-subtle transition-transform duration-[var(--duration-normal)] ease-out": true,
