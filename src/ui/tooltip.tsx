    ...
    <KobalteTooltip forceMount {...others} open={open()} onOpenChange={setOpen}>
      ...
      <KobalteTooltip.Portal>
        <KobalteTooltip.Content
          classList={{
            "z-[1000] max-w-[320px] rounded-md bg-background-element px-2.5 py-1": true,
            "text-[11px] font-medium text-text shadow-lg pointer-events-none!": true,
            "border border-border-subtle/60": true,
            "transition-all duration-[var(--duration-normal)] ease-out": true,
        ...
        >
          ...
          <KobalteTooltip.Arrow size={14} class="fill-background-element stroke-border-subtle/60 stroke-1" />
        </KobalteTooltip.Content>
      </KobalteTooltip.Portal>
    </KobalteTooltip>
  )
