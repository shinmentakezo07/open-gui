  ...
  return (
    <div
      ...
      class="
          ...
          [&_.line]:hover:bg-background-hover/50
          [&_.line::before]:sticky [&_.line::before]:left-0
          [&_.line::before]:w-12 [&_.line::before]:pr-4
          [&_.line::before]:z-10
          [&_.line::before]:bg-background
          [&_.line::before]:text-text-subtle
          ...
          [&_.diff-oldln]:z-40
          [&_.diff-oldln]:text-text-subtle
          [&_.diff-oldln]:text-right [&_.diff-oldln]:inline-block
          [&_.diff-oldln]:select-none
          [&_.diff-oldln]:bg-background
          [&_.diff-newln]:sticky [&_.diff-newln]:left-10
          [&_.diff-newln]:w-10 [&_.diff-newln]:pr-2
          [&_.diff-newln]:z-40
          [&_.diff-newln]:text-text-subtle
          [&_.diff-newln]:text-right [&_.diff-newln]:inline-block
          [&_.diff-newln]:select-none
          [&_.diff-newln]:bg-background
          [&_.diff-add]:bg-success/15!
          [&_.diff-add.diff-selected]:bg-success/40!
          [&_.diff-add_.diff-oldln]:bg-success!
          [&_.diff-add_.diff-oldln]:text-background!
          [&_.diff-add_.diff-newln]:bg-success!
          [&_.diff-add_.diff-newln]:text-background!
          [&_.diff-remove]:bg-error/15!
          [&_.diff-remove.diff-selected]:bg-error/40!
          [&_.diff-remove_.diff-newln]:bg-error!
          [&_.diff-remove_.diff-newln]:text-background!
          [&_.diff-remove_.diff-oldln]:bg-error!
          [&_.diff-remove_.diff-oldln]:text-background!
          ...
          [&_.diff-collapsed]:bg-info/15 [&_.diff-collapsed]:hover:bg-info/30!
          [&_.diff-collapsed]:text-info/70 [&_.diff-collapsed]:hover:text-info
